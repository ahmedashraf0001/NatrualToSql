...
const Settings: React.FC<SettingsProps> = ({ onClose, onNotification }) => {
                      ...
                      <Card>
                        ...
                        <CardContent className="space-y-4">
                          <CustomSelect
                            ...
                            onChange={(value) => updateSetting('appearance', 'theme', value as 'light' | 'dark' | 'system')}
                            options={[
                            ...
                            <div className="grid grid-cols-5 gap-2">
                              {PREDEFINED_THEMES.map((theme) => (
                                <button
                                  ...
                                  onClick={() => {
                                    updateSetting('appearance', 'primaryColor', theme.colors.primary)
                                  }}
                                  title={theme.name}
                                >
                                  <div
